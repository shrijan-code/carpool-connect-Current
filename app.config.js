...
module.exports = ({ config }) => {
    ...
    const env = {
        ...
        EXPO_PUBLIC_FIREBASE_API_KEY: process.env.FIREBASE_API_KEY || process.env.EXPO_PUBLIC_FIREBASE_API_KEY,
        EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN: process.env.FIREBASE_AUTH_DOMAIN || process.env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN,
        EXPO_PUBLIC_FIREBASE_PROJECT_ID: process.env.FIREBASE_PROJECT_ID || process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID,
        EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET: process.env.FIREBASE_STORAGE_BUCKET || process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET,
        EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID: process.env.FIREBASE_MESSAGING_SENDER_ID || process.env.EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID,
        EXPO_PUBLIC_FIREBASE_APP_ID: process.env.FIREBASE_APP_ID || process.env.EXPO_PUBLIC_FIREBASE_APP_ID,
        EXPO_PUBLIC_FIREBASE_MEASUREMENT_ID: process.env.FIREBASE_MEASUREMENT_ID || process.env.EXPO_PUBLIC_FIREBASE_MEASUREMENT_ID,
    };

    // Environment logging
    console.log('================================================');
    console.log(`[app.config.js] Environment: ${appEnv.toUpperCase()}`);
    console.log(`[app.config.js] Production Mode: ${isProduction ? 'YES ⚠️' : 'NO ✓'}`);
    console.log('================================================');
    ...
    if (isProduction) {
        console.log('[app.config.js] ⚠️  PRODUCTION BUILD - Using live credentials');
    }
    console.log('================================================');
